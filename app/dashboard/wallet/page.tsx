...
export default async function WalletPage() {
  ...
  if (!wallet) return <div className="p-6">Could not retrieve wallet info.</div>;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="mt-4 text-xs text-gray-400 text-center">
        * You can buy doping or pay for store fees with your wallet balance.
        <br/> All transactions are secured with SSL.
      </div>
    </div>
  );
}