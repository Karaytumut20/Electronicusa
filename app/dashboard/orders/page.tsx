...
export default function MyOrdersPage() {
  const orders = [
    { id: 'SP-102938', date: '25.01.2025', amount: '350 USD', items: 'Homepage Showcase', status: 'completed' },
    { id: 'SP-102939', date: '10.01.2025', amount: '150 USD', items: 'Urgent Label', status: 'completed' },
  ];

  return (
    <div className="bg-white border border-gray-200 rounded-sm shadow-sm p-6">
      <h2 className="text-xl font-bold text-[#333] mb-6 border-b border-gray-100 pb-2">My Orders</h2>
          ...
          <div key={order.id} className="border border-gray-200 rounded-sm p-4 flex flex-col md:flex-row justify-between items-center gap-4 hover:bg-gray-50 transition-colors">
            <div className="flex items-center gap-4 w-full md:w-auto">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Order No: {order.id}</p>
              </div>
            </div>
